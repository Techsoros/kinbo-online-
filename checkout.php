...
<html lang="en">
    <head>
        ...
        <title>কিনবো.com  | Checkout</title>
        <!-- Favicon-->
        ...
        <header class="bgtheme py-3">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">চেক-আউট করুন</h1>
                </div>
...
if($count==0):
echo "<font color='red'>আপনার এড্রেস আমাদের কাছে নেই। <br> এড্রেস যোগ করুন</font>";
else:
 ?>
 <form method="post">
...
<?php } endif;?>
<div align="right">
 <button class="btn-upper btn btn-success shadow" type="submit" name="proceedpayment">পেমেন্ট করুন</button>
</div>
</form>
...
<form method="post" name="address">
     ...
     <div class="row">
       ...
       <div class="row mt-3">
         ...
         <div class="row mt-3">
                 <div class="col-5">&nbsp;</div>
         <div class="col-6"><input type="submit" name="submit" id="submit" class="btn btn-warning shadow" value="ঠিকানা যোগ করুন" required></div>
     </div>
