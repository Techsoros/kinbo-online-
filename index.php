...
<head>
    ...
    <title> কিনবো.com || Homepage </title>
    <!-- Favicon-->
...
<body>
    ...
    <div class="container rocket px-5">

        <div class="row align-items-center">
            <div class="col-md-6 col-sm-12 col-xs-12">
                <h2> অনলাইনে পন্য কিনুন খুব সহজে</h2>
                <h1> কিনবো.com থেকে</h1>
                <div class="cr__btn">
                    <a href="products.php " class="btn btn-primary btn-lg">Shop Now</a>
                </div>
            </div>
            <div class="col-md-6 col-sm-12 col-xs-12">
                <img src="assets/rocketbg.png" alt="" width="100%">
            </div>
        </div>
    ...
    <!-- Header-->
    <header class="bg-light py-5 bgtheme">
        <div class="container px-4 px-lg-3">
            <div class="text-center text-light">
                <h1 class="display-4 fw-bolder">পন্য সমুহ</h1>
                <p>আমরা আপনাকে সবচেয়ে ভালো প্রোডাক্ট টি দেয়ার জন্যে প্রতিজ্ঞাবদ্ধ</p>
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center">
                                ...
                                <!-- Product price-->
                                <span
                                    class="text-decoration-line-through"><?php echo htmlentities($row['productPriceBeforeDiscount']);?>টাকা</span>
                                - <?php echo htmlentities($row['productPrice']);?> টাকা
                            </div>
                        </div>
                        <!-- Product actions-->
                        <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                            <div class="text-center"><a class="btn  mt-auto hovertheme"
                                    href="product-details.php?pid=<?php echo htmlentities($row['pid']);?>">কিনতে চাই</a></div>
                        </div>
                    </div>
                </div>
                <?php } ?>
