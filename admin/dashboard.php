...
<html lang="en">
    <head>
        ...
        <title>কিনবো.com  | Admin Dashboard</title>
                                ...
                                <div class="card bg-light text-dark h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-dark-75 small">Total Order</div>
                                                <div class="text-lg fw-bold"><?php echo $torders; ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between small">
                                        <a class="text-dark stretched-link" href="all-orders.php">View Details</a>
                            ...
                            <div class="col-lg-6 col-xl-3 mb-4">
                                <div class="card bg-light text-dark h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-dark-75 small">New Orders</div>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between small">
                                        <a class="text-dark stretched-link" href="new-order.php">View Details</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-3 mb-4">
                                <div class="card bg-light text-dark h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-dark-75 small">Packed Orders</div>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between small">
                                        <a class="text-dark stretched-link" href="packed-orders.php">View Tasks</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-3 mb-4">
                                <div class="card bg-light text-dark h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-dark-75 small">Dispatched Orders</div>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between small">
                                        <a class="text-dark stretched-link" href="dispatched-orders.php">View Requests</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-lg-6 col-xl-3 mb-4">
                                <div class="card bg-light text-dark h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-dark-75 small">In Transit Orders</div>
                                                <div class="text-lg fw-bold"><?php echo $intorders; ?></div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between small">
                                        <a class="text-dark stretched-link" href="intransit-orders.php">View Details</a>
                            ...
                            <div class="col-lg-6 col-xl-3 mb-4">
                                <div class="card bg-light text-dark h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-dark-75 small">Out for Delivery Orders</div>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between small">
                                        <a class="text-dark stretched-link" href="outfordelivery-orders.php">View Details</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-3 mb-4">
                                <div class="card bg-light text-dark h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-dark-75 small">Delivered Orders</div>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between small">
                                        <a class="text-dark stretched-link" href="delivered-orders.php">View Details</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-xl-3 mb-4">
                                <div class="card bg-light text-dark h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-dark-75 small">Registered Users</div>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between small">
                                        <a class="text-dark stretched-link" href="registered-users.php">View Requests</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                               ...
                               <div class="col-lg-6 col-xl-3 mb-4">
                                <div class="card bg-light text-dark h-100">
                                    <div class="card-body">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="me-3">
                                                <div class="text-dark-75 small">Cancelled Orders</div>
                                    ...
                                    <div class="card-footer d-flex align-items-center justify-content-between small">
                                        <a class="text-dark stretched-link" href="cancelled-orders.php">View Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
