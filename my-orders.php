...
<html lang="en">
    <head>
        ...
        <title>কিনবো.com  | My Orders</title>
        <!-- Favicon-->
        ...
        <header class="bgtheme py-3">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">আমার অর্ডার</h1>
                </div>
...
?>
                ...
                <?php $cnt++;}  } else{ ?>
                <tr>
                    <td style="font-size: 18px; font-weight:bold ">আপনি এখনো কোন কিছু কেনাকাটা করেন নি.&nbsp; <br><br>
