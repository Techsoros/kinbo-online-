        ...
        <header class="bgtheme py-3">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    ...
                    <p>আপনি এখানে আপনার পাসওয়ার্ড পরিবর্তন করতে পারবেন </p>
                </div>
     ...
     <input type="password" class="form-control" id="newpass" name="newpass">
       ...
       <div class="row mt-3">
         ...
         <div class="col-6"><input type="password" class="form-control" id="cnfpass" name="cnfpass" required="required" ></div>
               ...
               <div class="row mt-3">
                 <div class="col-4">&nbsp;</div>
         <div class="col-6"><input type="submit" name="update" id="update" class="btn btn-success shadow px-5 py-2" value="আপডেট করুন" required></div>
     </div>
 </form>
