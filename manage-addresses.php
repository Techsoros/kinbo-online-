...
<html lang="en">
    <head>
        ...
        <title>কিনবো.com  | my address</title>
        <!-- Favicon-->
        ...
        <header class="bgtheme py-3">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">আমার ঠিকানা সমুহ</h1>
                </div>
...
<form method="post" name="address">
     ...
     <div class="row">
       ...
       <div class="row mt-3">
         ...
         <div class="row mt-3">
                 <div class="col-5">&nbsp;</div>
         <div class="col-6"><input type="submit" name="submit" id="submit" class="btn btn-success px-5 py-2 shadow mt-3" value="ঠিকানা যোগ করুন" required></div>
     </div>
