...
<html lang="en">
    <head>
        ...
        <title>কিনবো.com | Category wise Shop </title>
        <!-- Favicon-->
...
<?php include_once('includes/header.php');?>
        <!-- Header-->
        <header class="bg-dark py-5 bgtheme">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <!-- Product price-->
                                    <span class="text-decoration-line-through"><?php echo htmlentities($row['productPriceBeforeDiscount']);?>টাকা</span> - <?php echo htmlentities($row['productPrice']);?>টাকা
                                </div>
                            </div>
                             <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn  mt-auto hovertheme" href="product-details.php?pid=<?php echo htmlentities($row['pid']);?>">কিনতে চাই</a></div>
                            </div>
                        </div>
                    </div>
                <?php } }  else{ ?>
                    
     <h4 style="text-align:center;color:#c6E6b;font-size:20px;">এ ক্যাটাগরি তে কোন পন্য পাওয়া যায়নি</h4>
<?php } ?>
                </div>
            </div>
