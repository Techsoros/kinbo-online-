...
?>
                <div class="text-center text-white">
                    ...
                    <p>এখান থেকে আপনি আপনার তথ্য সংশোধন ও পরিবর্তন করতে পারেন</p>
                </div>
     ...
     <div class="row">
       ...
       <div class="row mt-3">
         ...
         <div class="col-6"><input type="text" name="contactnumber" value="<?php echo htmlentities($result['contactno']);?>" pattern="[0-9]{10}" title="10 numeric characters only" class="form-control" required></div>
               ...
               <div class="row mt-3">
                 <div class="col-4">&nbsp;</div>
         <div class="col-6"><input type="submit" name="update" id="update" class="btn btn-warning px-5 py-2 shadow" value="আপডেট করুন" required></div>
     </div>
 </form>
