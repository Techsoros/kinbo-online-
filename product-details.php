...
<html lang="en">
    <head>
        ...
        <title>কিনবো.com | Product Details</title>
        <!-- Favicon-->
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="admin/productimages/<?php echo htmlentities($row['productImage1']);?>" alt="<?php echo htmlentities($row['productName']);?>" width="500"   style="border:solid 1px #ddd;"/>
<img src="admin/productimages/<?php echo htmlentities($row['productImage2']);?>" width="291" style="border:solid 1px #ddd;">
<img src="admin/productimages/<?php echo htmlentities($row['productImage3']);?>" width="292" style="border:solid 1px #ddd;">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="fs-5 mb-5">
                            <span class="text-decoration-line-through text-muted"><?php echo htmlentities($row['productPriceBeforeDiscount']);?>টাকা </span>
                            <span><?php echo htmlentities($row['productPrice']);?>টাকা </span>
...
<?php if($row['productAvailability']=='In Stock'):?>
                        ...
                        <div class="d-flex">
                            <input class="form-control text-center me-3 hovertheme" id="inputQuantity" name="inputQuantity" type="num" value="1" style="max-width: 3rem" />
                            <button class="btn hovertheme flex-shrink-0" type="submit" name="addtocart">
                                <i class="bi-cart-fill me-1"></i>
                                Add to cart
                            </button> &nbsp;
   <button class="btn hovertheme flex-shrink-0" type="submit" name="wishlist">
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <!-- Product price-->
                                    <span class="text-decoration-line-through"><?php echo htmlentities($row['productPriceBeforeDiscount']);?> টাকা</span>
                            <span class="fw-bold"><?php echo htmlentities($row['productPrice']);?> টাকা</span>
                                </div>
                            </div>
                            <!-- Product actions-->
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><a class="btn hovertheme mt-auto" href="product-details.php?pid=<?php echo htmlentities($row['pid']);?>">কিনতে চাই</a></div>
                            </div>
                        </div> 
                    </div>
<?php } ?>
