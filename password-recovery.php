...
<html lang="en">
    <head>
        ...
        <title>কিনবো.com | password manager</title>
        <!-- Favicon-->
        ...
        <header class="bgtheme py-3">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">পাসওয়ার্ড পুনুরুদ্ধার করুন </h1>
...
<form method="post" name="passwordrecovery" onSubmit="return valid();">
       ...
       <div class="row mt-3">
         ...
         <div class="col-6"><input type="password" name="cinputPassword" id="cinputPassword" class="form-control" required></div>
               ...
               <div class="row mt-3">
                 <div class="col-4">&nbsp;</div>
         <div class="col-6"><input type="submit" name="submit" id="submit" class="btn btn-warning shadow px-5" value="জমা দিন" required></div>
     </div>
 </form>
