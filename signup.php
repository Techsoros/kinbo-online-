...
<html lang="en">
    <head>
        ...
        <title>কিনবো.com | User Sign up</title>
        <!-- Favicon-->
        ...
        <header class="bgtheme py-3">
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <div class="text-center text-white">
                    <h1 class="display-4 fw-bolder">নতুন একাউন্ট খুলুন</h1>
                    <p class="lead fw-normal text-white-50 mb-0">রেজিস্ট্রেশন করে কেনাকাটা শুরু করুন</p> <hr>
                    <p class="lead fw-normal text-light mb-1 ">আগে রেজিস্ট্রেশন করে থাকলে লগ-ইন করুন </p> 
                <a href="login.php"><button type="button" class="btn btn-success btn-lg">লগ-ইন</button></a>
                </div>
...
<form method="post" name="signup">
 ...
 <span id="user-email-status" style="font-size:12px;"></span>
       ...
       <div class="row mt-3">
         ...
         <div class="col-6"><input type="text" name="contactnumber" pattern="[0-9]{11}" title="11 numeric characters only" class="form-control" required></div>
     </div>
         ...
         <div class="col-6"><input type="password" name="inputuserpwd" class="form-control" required></div>
               ...
               <div class="row mt-3">
                 <div class="col-4">&nbsp;</div>
         <div class="col-6"><input type="submit" name="submit" id="submit" value="রেজিস্টার" class="btn btn-success btn-lg" required></div>
     </div>
 </form>
